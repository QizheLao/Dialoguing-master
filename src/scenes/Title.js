class Title extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('kappa', 'img/Kappa.png')

        // load bitmap font
        this.load.bitmapFont('gem_font', 'font/gem.png', 'font/gem.xml')
        this.load.bitmapFont('Mickey_font', 'font/Wickey.png', 'font/Wickey.xml')
    }

    create() {
        // add title text
        this.add.bitmapText(centerX, centerY - 64, 'Mickey_font', 'THE ODYSSEY', 64).setOrigin(0.5)
